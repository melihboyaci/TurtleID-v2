...
| ⚙️ **PreprocessingWorker** | _(Görüntü iyileştirme YAPMAZ)_ Doğrulanmış kafa görselini, derin öğrenme modelinin beklediği Tensör formatına (224x224, preprocess_input, batch boyutu) dönüştürür.               |
